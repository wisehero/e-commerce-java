...
/**
 * 주문 라인 준비 담당. SKU·상품·브랜드를 조회해 구매 가능 여부를 검증하고,
 * 주문 시점 스냅샷인 OrderLine과 쿠폰 계산용 중립 입력인 DiscountableLine을 만들며,
 * 선택된 전략으로 재고를 차감한다.
 *
...
public class OrderLinePreparer {
    ...
    public OrderLinePreparer(SkuRepository skuRepository, ProductRepository productRepository,
        BrandRepository brandRepository, Map<String, StockDeducter> stockDeducters) {
