...
public class CouponPolicy {
    ...
    private CouponPolicy(Long id, String name, DiscountRule discountRule, int validDays,
    ...
    public static CouponPolicy create(String name, DiscountRule discountRule, int validDays,
        ZonedDateTime issuableFrom, ZonedDateTime issuableUntil, long maxIssueCount, boolean active) {
        return new CouponPolicy(null, name, discountRule, validDays, issuableFrom, issuableUntil,
            maxIssueCount, 0, active);
    }

    public static CouponPolicy reconstitute(Long id, String name, DiscountRule discountRule, int validDays,
        ZonedDateTime issuableFrom, ZonedDateTime issuableUntil, long maxIssueCount, long issuedCount,
        boolean active) {
        return new CouponPolicy(id, name, discountRule, validDays, issuableFrom, issuableUntil,
            maxIssueCount, issuedCount, active);
    }
